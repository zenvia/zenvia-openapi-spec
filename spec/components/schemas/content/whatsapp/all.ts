...
import { ref as flowResponseRef } from './flow-response';
import { ref as unsupportedRef } from './unsupported';
import mt from './mt';

const all: SchemaObject = _.cloneDeep(mt);
all.oneOf.push({$ref: flowResponseRef}, { $ref: productListOrderRef }, { $ref: unsupportedRef, 'x-unpublished': true });
all.discriminator.mapping.flow_response = flowResponseRef;
