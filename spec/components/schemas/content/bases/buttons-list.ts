...
export const buttonsList: SchemaObject = {
  ...
  description: `Vertical list of buttons displayed inside a card. These will *not* fade away once a button is clicked.<br>
    ...
    <br>*[Telegram](#tag/Telegram): The \`link\` type cannot be used with \`text\` or \`share_location\`. Supported types: \`text\`, \`link\` and \`share_location\`. It's not possible to send buttons and quickreplybuttons at the time*`,
  maxItems: 4,
  items: {
    $ref: buttonsRef,
  },
